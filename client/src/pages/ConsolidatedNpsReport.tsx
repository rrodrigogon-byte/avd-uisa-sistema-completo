...
export default function ConsolidatedNpsReport() {
  ...
  const { data: summary } = trpc.consolidatedNpsReport.getDashboardSummary.useQuery(undefined);
  const { data: pirIntegrity } = trpc.consolidatedNpsReport.checkPirIntegrity.useQuery(undefined);
