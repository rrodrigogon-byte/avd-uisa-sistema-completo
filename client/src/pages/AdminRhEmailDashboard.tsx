...
export default function AdminRhEmailDashboard() {
  ...
  // Buscar estatísticas
  const { data: stats, isLoading: loadingStats, refetch: refetchStats } = trpc.adminRhEmailDashboard.stats.useQuery(undefined);

  // Buscar dados do gráfico
  const { data: chartData, isLoading: loadingChart } = trpc.adminRhEmailDashboard.chartData.useQuery(undefined);
