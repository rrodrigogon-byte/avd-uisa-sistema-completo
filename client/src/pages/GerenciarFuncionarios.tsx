...
export default function GerenciarFuncionarios() {
  ...
  const { data: departments } = trpc.employeeManagement.listDepartments.useQuery(undefined);
  const { data: positions } = trpc.employeeManagement.listPositions.useQuery(undefined);
  const { data: managers } = trpc.employeeManagement.listManagers.useQuery(undefined);
