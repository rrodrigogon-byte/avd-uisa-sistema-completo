        ...
        <Card className="max-w-2xl w-full">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-base mt-2">
              Obrigado por completar o Teste de Inteligência Emocional, {result.employeeName}!
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
              <h3 className="font-semibold text-lg mb-2">Seu Perfil de Inteligência Emocional</h3>
      ...
      <div className="max-w-3xl mx-auto p-4 py-8 space-y-6">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold tracking-tight">Teste de Inteligência Emocional</h1>
          </div>
