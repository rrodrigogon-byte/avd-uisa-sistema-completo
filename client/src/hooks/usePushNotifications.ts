...
export function usePushNotifications() {
  ...
  const { data: publicKeyData } = trpc.pushNotifications.getPublicKey.useQuery(undefined);
  const { data: subscriptionStatus } = trpc.pushNotifications.hasSubscription.useQuery(undefined);
