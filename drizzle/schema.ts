...
// ============================================================================
// FLUXO DE APROVAÇÃO DE DESCRIÇÕES DE CARGOS - NOVO SISTEMA
// ============================================================================
 ...
 * 1. Líder Imediato
 * 2. Especialista de Cargos e Salários
 * 3. Gerente de RH
 * 4. Diretor de Gente, Administração e Inovação
 */
export const jobDescriptionApprovalFlow = mysqlTable("jobDescriptionApprovalFlow", {
  id: int("id").autoincrement().primaryKey(),
  jobDescriptionId: int("jobDescriptionId").notNull(),
  
  // Versão do fluxo (para histórico)
  ...
  leaderStatus: mysqlEnum("leaderStatus", ["pending", "approved", "rejected", "returned"]).default("pending").notNull(),
  leaderComments: text("leaderComments"),
  leaderDecidedAt: datetime("leaderDecidedAt"),
  
  // Nível 2: Especialista de Cargos e Salários
  csSpecialistId: int("csSpecialistId").notNull(),
  csSpecialistName: varchar("csSpecialistName", { length: 255 }),
  csSpecialistStatus: mysqlEnum("csSpecialistStatus", ["pending", "approved", "rejected", "returned"]).default("pending").notNull(),
  csSpecialistComments: text("csSpecialistComments"),
  csSpecialistDecidedAt: datetime("csSpecialistDecidedAt"),
  
  // Nível 3: Gerente de RH
  hrManagerId: int("hrManagerId").notNull(),
  hrManagerName: varchar("hrManagerName", { length: 255 }),
  hrManagerStatus: mysqlEnum("hrManagerStatus", ["pending", "approved", "rejected", "returned"]).default("pending").notNull(),
  hrManagerComments: text("hrManagerComments"),
  hrManagerDecidedAt: datetime("hrManagerDecidedAt"),
  
  // Nível 4: Diretor de Gente, Administração e Inovação
  gaiDirectorId: int("gaiDirectorId").notNull(),
  gaiDirectorName: varchar("gaiDirectorName", { length: 255 }),
  gaiDirectorStatus: mysqlEnum("gaiDirectorStatus", ["pending", "approved", "rejected", "returned"]).default("pending").notNull(),
  gaiDirectorComments: text("gaiDirectorComments"),
  gaiDirectorDecidedAt: datetime("gaiDirectorDecidedAt"),
...
export type JobDescriptionApprovalFlow = typeof jobDescriptionApprovalFlow.$inferSelect;
export type InsertJobDescriptionApprovalFlow = typeof jobDescriptionApprovalFlow.$inferInsert;
...
export const jobDescriptionApprovalHistory = mysqlTable("jobDescriptionApprovalHistory", {
  ...
  // Nível em que a ação ocorreu (1-4)
  level: int("level").notNull(),
...
/**
 * Rotinas do Usuário - Atividades recorrentes mapeadas manualmente
 */
export const activityRoutines = mysqlTable("activityRoutines", {
  id: int("id").autoincrement().primaryKey(),
  employeeId: int("employeeId").notNull(),
  ...
  isLinkedToJobDescription: boolean("isLinkedToJobDescription").default(false).notNull(),
  matchPercentage: int("matchPercentage").default(0),
  matchNotes: text("matchNotes"),
  
  // Dias da semana (para rotinas diárias/semanais)
  weekDays: json("weekDays"), // Array de 0-6 (domingo-sábado)
...
export type ActivityRoutine = typeof activityRoutines.$inferSelect;
export type InsertActivityRoutine = typeof activityRoutines.$inferInsert;

/**
 * Logs de Atividades de Desktop/Laptop - Coleta Automática
 */
export const desktopActivityLogs = mysqlTable("desktopActivityLogs", {
  id: int("id").autoincrement().primaryKey(),
  employeeId: int("employeeId").notNull(),
  ...
  // Detalhes da atividade
  applicationName: varchar("applicationName", { length: 255 }),
  windowTitle: varchar("windowTitle", { length: 500 }),
  ...
  autoCategory: varchar("autoCategory", { length: 100 }),
  matchedResponsibilityId: int("matchedResponsibilityId"),
  confidenceScore: int("confidenceScore"), // 0-100
  
  // Metadados do dispositivo
  deviceId: varchar("deviceId", { length: 100 }),
  deviceType: mysqlEnum("deviceType", ["desktop", "laptop", "mobile"]).default("desktop"),
...
export type DesktopActivityLog = typeof desktopActivityLogs.$inferSelect;
export type InsertDesktopActivityLog = typeof desktopActivityLogs.$inferInsert;

/**
 * Confronto de Atividades com Descrição de Cargo
 */
export const activityJobDescriptionMatch = mysqlTable("activityJobDescriptionMatch", {
  id: int("id").autoincrement().primaryKey(),
  employeeId: int("employeeId").notNull(),
  jobDescriptionId: int("jobDescriptionId").notNull(),
  ...
  totalActivitiesLogged: int("totalActivitiesLogged").default(0),
  activitiesMatchedToJob: int("activitiesMatchedToJob").default(0),
  activitiesNotInJob: int("activitiesNotInJob").default(0),
  responsibilitiesNotExecuted: int("responsibilitiesNotExecuted").default(0),
  
  // Percentuais
  adherencePercentage: int("adherencePercentage").default(0), // 0-100
  coveragePercentage: int("coveragePercentage").default(0), // 0-100
  
  // Detalhes em JSON
  matchDetails: json("matchDetails"), // Array de {responsibilityId, activityCount, timeSpent}
  gapsIdentified: json("gapsIdentified"), // Array de {type, description, severity}
  suggestedAdjustments: json("suggestedAdjustments"), // Array de {type, description, priority}
  
  // Resumo executivo
  executiveSummary: text("executiveSummary"),
  
  // Status
  status: mysqlEnum("status", ["processing", "completed", "reviewed"]).default("processing").notNull(),
  reviewedBy: int("reviewedBy"),
  reviewedAt: datetime("reviewedAt"),
...
export type ActivityJobDescriptionMatch = typeof activityJobDescriptionMatch.$inferSelect;
export type InsertActivityJobDescriptionMatch = typeof activityJobDescriptionMatch.$inferInsert;

/**
 * Configuração de Aprovadores Padrão por Departamento
 */
export const departmentApprovalConfig = mysqlTable("departmentApprovalConfig", {
  id: int("id").autoincrement().primaryKey(),
  departmentId: int("departmentId").notNull(),
  
  // Aprovadores padrão para o departamento
  defaultCsSpecialistId: int("defaultCsSpecialistId"),
  defaultCsSpecialistName: varchar("defaultCsSpecialistName", { length: 255 }),
  
  defaultHrManagerId: int("defaultHrManagerId"),
  defaultHrManagerName: varchar("defaultHrManagerName", { length: 255 }),
  
  defaultGaiDirectorId: int("defaultGaiDirectorId"),
  defaultGaiDirectorName: varchar("defaultGaiDirectorName", { length: 255 }),
...
export type DepartmentApprovalConfig = typeof departmentApprovalConfig.$inferSelect;
export type InsertDepartmentApprovalConfig = typeof departmentApprovalConfig.$inferInsert;

// ============================================================================
// RELATIONS - Novas tabelas
// ============================================================================

export const jobDescriptionApprovalFlowRelations = relations(jobDescriptionApprovalFlow, ({ one, many }) => ({
  jobDescription: one(jobDescriptions, {
    fields: [jobDescriptionApprovalFlow.jobDescriptionId],
    references: [jobDescriptions.id],
  }),
  history: many(jobDescriptionApprovalHistory),
}));

export const jobDescriptionApprovalHistoryRelations = relations(jobDescriptionApprovalHistory, ({ one }) => ({
  flow: one(jobDescriptionApprovalFlow, {
    fields: [jobDescriptionApprovalHistory.flowId],
    references: [jobDescriptionApprovalFlow.id],
  }),
  jobDescription: one(jobDescriptions, {
    fields: [jobDescriptionApprovalHistory.jobDescriptionId],
    references: [jobDescriptions.id],
  }),
}));

export const activityRoutinesRelations = relations(activityRoutines, ({ one }) => ({
  employee: one(employees, {
    fields: [activityRoutines.employeeId],
    references: [employees.id],
  }),
  jobDescription: one(jobDescriptions, {
    fields: [activityRoutines.jobDescriptionId],
    references: [jobDescriptions.id],
  }),
  responsibility: one(jobResponsibilities, {
    fields: [activityRoutines.responsibilityId],
    references: [jobResponsibilities.id],
  }),
}));

export const desktopActivityLogsRelations = relations(desktopActivityLogs, ({ one }) => ({
  employee: one(employees, {
    fields: [desktopActivityLogs.employeeId],
    references: [employees.id],
  }),
  matchedResponsibility: one(jobResponsibilities, {
    fields: [desktopActivityLogs.matchedResponsibilityId],
    references: [jobResponsibilities.id],
  }),
}));

export const activityJobDescriptionMatchRelations = relations(activityJobDescriptionMatch, ({ one }) => ({
  employee: one(employees, {
    fields: [activityJobDescriptionMatch.employeeId],
    references: [employees.id],
  }),
  jobDescription: one(jobDescriptions, {
    fields: [activityJobDescriptionMatch.jobDescriptionId],
    references: [jobDescriptions.id],
  }),
}));

export const departmentApprovalConfigRelations = relations(departmentApprovalConfig, ({ one }) => ({
  department: one(departments, {
    fields: [departmentApprovalConfig.departmentId],
    references: [departments.id],
  }),
}));
