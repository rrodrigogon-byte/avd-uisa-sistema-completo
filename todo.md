...
## 🆕 NOVOS REQUISITOS (14/12/2025)

### Correções Urgentes
- [x] Corrigir erro 404 em "Testes de Integridade" - página não encontrada - **VERIFICADO: Página funcionando corretamente**
- [x] Implementar página funcional de Testes de Integridade - **CONCLUÍDO: 6 convites carregando com sucesso**

### Configuração de Aprovadores Padrão
- [x] Criar tabela defaultApprovers no banco de dados
- [x] Criar router tRPC para gerenciar aprovadores padrão
- [x] Criar página de administração de aprovadores padrão
- [x] Implementar funcionalidade de inicializar aprovadores UISA
- [x] Cadastrar IDs dos aprovadores padrão no sistema:
  - [x] Alexsandra Oliveira (ALEXSANDRA TAVARES SOBRAL DE OLIVEIRA - Nível 2)
  - [x] André (Nível 3 - Gerente de RH)
  - [x] Rodrigo Ribeiro Gonçalves (RODRIGO RIBEIRO GONCALVES - Nível 4)
- [x] Configurar workflow de aprovações automático com 4 níveis

### Teste de Fluxo Completo
- [ ] Criar descrição de cargo de teste
- [ ] Acompanhar workflow pelos 4 níveis de aprovação
- [ ] Validar todo o processo de aprovação

### Campos Dinâmicos em Descrições de Cargos
- [ ] Implementar funcionalidade de adicionar campos dinamicamente
- [ ] Implementar funcionalidade de remover campos
- [ ] Implementar funcionalidade de reordenar campos

### PIR - Programa de Integridade Respiratória (Completo)
- [x] Criar schema de banco de dados para PIR completo - **8 tabelas criadas**
  - [ ] Tabela de programas PIR
  - [ ] Tabela de participantes do programa
  - [ ] Tabela de testes de integridade (fit tests)
  - [ ] Tabela de gravações de vídeos dos testes
  - [ ] Tabela de equipamentos de proteção respiratória
  - [ ] Tabela de treinamentos
  - [ ] Tabela de exames médicos
  - [ ] Tabela de histórico de uso de EPR
- [ ] Implementar procedures tRPC para PIR completo
  - [ ] Gestão de programas PIR
  - [ ] Cadastro de participantes
  - [ ] Registro de testes de integridade com vídeo
  - [ ] Gestão de equipamentos
  - [ ] Controle de treinamentos
  - [ ] Registro de exames médicos
  - [ ] Histórico de uso
- [ ] Implementar frontend do PIR completo
  - [ ] Dashboard do programa PIR
  - [ ] Cadastro e gestão de participantes
  - [ ] Realização de testes de integridade com gravação de vídeo
  - [ ] Gestão de equipamentos de proteção respiratória
  - [ ] Controle de treinamentos obrigatórios
  - [ ] Registro de exames médicos ocupacionais
  - [ ] Relatórios de conformidade
  - [ ] Histórico completo por funcionário
- [ ] Implementar gravação de vídeos dos testes
  - [ ] Captura de vídeo via webcam
  - [ ] Upload para S3
  - [ ] Reprodução de vídeos gravados
  - [ ] Armazenamento de metadados
- [ ] Implementar funcionalidades do método PIR
  - [ ] Protocolo de teste qualitativo
  - [ ] Protocolo de teste quantitativo
